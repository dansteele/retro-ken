...
describe RetroKen::Commands::Retro do
  it 'starts a retrospective' do
    expect(message: 'retroken retro start').to(
      respond_with_slack_message('Say `RetroKen retro stop` to end. Need help? Just ask me for `help` in a private message. https://media.giphy.com/media/26DOs997h6fgsCthu/giphy.gif'))
  end
